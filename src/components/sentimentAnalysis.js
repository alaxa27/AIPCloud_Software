...
const mapStateToProps = function(state) {
  return {
    fetched: state.textSentiment.fetched,
    fetching: state.textSentiment.fetching}
}
          ...
          <BlockUi tag="div" blocking={this.props.fetching}>
            <div className="card">
              <h4 className="card-header card-title">
                Analyse de sentiments dans un texte
              </h4>
              <div className="card-block">
                ...
                <div className="row">
                  <div className="col">
                    <button type="submit" className="btn btn-sm btn-primary" onClick={this.fetchTextSentiment.bind(this)}>Analyser !</button>
                  </div>
